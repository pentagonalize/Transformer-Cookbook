...
\AY{Emile can define GeLU if he has time}
\AY{Maybe look into defining the other activation functions?}
\begin{definition}{$\ReLU$}{}
    The activation function $\ReLU \colon \R^d\to \R^d$, which stands for \say{Rectified Linear Unit}, is a standard component of feed-forward layers, where
