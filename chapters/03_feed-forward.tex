...
\end{definition}
\DC{This definition doesn't agree with the one in \cref{sec:ffnn_multiplication}.}\AY{Include all definitions from paper (and number them)}
