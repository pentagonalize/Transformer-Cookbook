...
\AY{Potentially how we can structure this}\AY{Testing git}
...
\begin{definition}{$\ReLU$}{}
    The activation function $\ReLU : \R^d\to \R^d$, which stands for ``Rectified Linear Unit", is a standard component of feed-forward layers, where
